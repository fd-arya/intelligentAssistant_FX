 ...
 */
public enum MedicineMenu implements IMenuItemManager {
    ...
    MEDICINE_MANAGER(0) {
        ...
        public MenuItem getItem( Locale l ){
            ...
            return new MenuItem("MedicineManager");
        }
    ...
    MedicineMenu(int no ){ this.no = no; }

    public static Menu getMenu( Locale l ){

        Menu menu = new Menu("Medicine");
        for( MedicineMenu a : MedicineMenu.values() ){
